...
# Part of BrowseInfo. See LICENSE file for full copyright and licensing details.
{
    ...
    "author": "BROWSEINFO",
    "website" : "https://www.browseinfo.com/demo-request?app=bi_sport_center_management&version=18&edition=Community",
    "price": 99,
    "currency": 'EUR',
    'depends': ['base', 'mail', 'account', 'product', 'website', 'contacts', 'event','website_event_sale','stock','purchase'],
    'data': [
    ...
    'installable': True,
    'auto_install': False,
    'live_test_url':'https://www.browseinfo.com/demo-request?app=bi_sport_center_management&version=18&edition=Community',
